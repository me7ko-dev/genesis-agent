...
def main() -> None:
    ...
    labels = {
        ...
        # Различно от горното, макар и двете да са verified=False: умението
        # иска операция, която проверката отказва без надзор (подпроцес,
        # chmod). Недоказано, не доказано опасно — и точно тук са уменията,
        # които вършат истинска работа.
        "needs_confirmation": "🔒 непроверими без надзор",
        "runtime_err": "❌ грешка",
