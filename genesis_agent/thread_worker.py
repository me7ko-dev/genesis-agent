...
# Находките се изпращат като известие И се пазят в нишката. Този режим върви БЕЗ надзор
...
# известието. Затова всичко минава през редакция преди запис/изпращане.
