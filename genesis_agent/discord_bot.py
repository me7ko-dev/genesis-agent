...
pool от теми (90 към 2026-08-12, разпределени в 7 домейна) — цикълът ще го
изчерпи и ще идле грациозно, не генерира безкрайно нови цели (познато
ограничение, не е бъг тук). По-ранна версия на този текст твърдеше ~24; броят
се чете от genesis_agent.goal_engine._DOMAINS, ако трябва да се провери.
"""
